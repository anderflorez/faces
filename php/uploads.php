					...
					if (isset($_POST['upload'])) {
						...
						if ($_FILES) {
							...
							if ($db->query($sql) === TRUE) {
								echo '<div style="background-color: #D3FDE5; text-align: center; padding: 10px;">The picture has been saved successfully!</div>';
							}
							else {
								echo '<div style="background-color: #FF9999; text-align: center; padding: 10px;">Error saving the new picture</div>';
							}
						}
					}
				?>				
